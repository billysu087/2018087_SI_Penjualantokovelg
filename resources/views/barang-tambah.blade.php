        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container w-50 border p-4 mt-5">
                    <form action="/barang/updateProcess" method="post">
                        {{ csrf_field() }}
                        <div class="mb-3">
                            <label class="form-label">ID Barang</label>
                            <input class="form-control" name="id_barang">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">ID Pegawai</label> <br>
                            <select class="form-select" aria-label="Default select example" name="id_pegawai">
                                <option selected>Pilih id_pegawai di bawah ini</option>
                        ...
                        <div class="mb-3 form-label">
                            ...
                            <input class="form-control" name="masuk">
                        </div>
                        <div class="mb-3 form-label">
                            <label class="form-label">Keluar Barang</label>
                            <input class="form-control" name="keluar">
                        </div>
